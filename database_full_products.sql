...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2023 at 04:58 PM
...
(106, 'AirPod Gen 3', 169.00, 'airpods3-e1634579735355.png', 'Cập nhật thiết kế\r\nAirPods có trọng lượng nhẹ và có thiết kế đường viền. Chúng nằm ở góc vừa phải để tạo sự thoải mái và hướng âm thanh đến tai bạn tốt hơn. Thân máy ngắn hơn 33% so với AirPods (thế hệ 2) và bao gồm cảm biến lực để dễ dàng điều khiển nhạc và cuộc gọi.', 0, 152),
(107, 'AirPod Max', 549.00, 'airpods-max-select-pink-202011.png', 'Chế độ trong suốt và khử tiếng ồn chủ động\r\n\r\n—\r\n\r\n\r\nÂm thanh không gian được cá nhân hóa với tính năng theo dõi chuyển động đầu chủ độngᴼ\r\n\r\n—\r\n\r\n\r\nỐp lưng thông minh\r\n\r\n20 giờ\r\n\r\nThời gian nghe lên đến 20 giờ với một lần sạcOOO', 0, 152);
